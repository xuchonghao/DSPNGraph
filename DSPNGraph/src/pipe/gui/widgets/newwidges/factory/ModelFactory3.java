...
//       XMLOut.output(doc, new FileOutputStream("C://Users//Administrator//Desktop//test1234.xml"));
    ...
    public static void setVLNUMBER(int VLNUMBER) {
        ModelFactory3.VLNUMBER = VLNUMBER;
    }
...
/*
    public static void addVL1(VLInfo info,Element net,int x,int y,ArrayList<VLInfo> infoList,double lxPeriod){
     ...
     * @return place
     */
    public static Element buildPlace(Element net, String placeName ,int initailMark, int x, int y)
    {
...
//    place.setAttribute("id", "P"+pIndex);
    ...
    public static void setListOfSpmLinkEnd(ArrayList<Element> listOfSpmLinkEnd) {
        ModelFactory3.listOfSpmLinkEnd = listOfSpmLinkEnd;
    }
