 ...
 * 建模向导第五步，选择交换机的数量
 */
public class ModelGuideDialog44 extends JDialog {
   ...
   // private JRadioButton jRadioButton4;
    ...
    public ModelGuideDialog44(Frame parent, boolean modal, GuideModel guideModel,ArrayList<Element> arr) {
        super(parent, modal);
        nowModel = guideModel;
        this.arr = arr;
        initComponents();
    ...
    private void initComponents() {
        ...
        if(nowModel.getNumOfSW()>3)
        {
            jTextField1.setText(nowModel.getNumOfSW()+"");
        }
        //jLabel5.setText("其他");
        ...
        jLabel4.setText("根据系统情况，请选择AFDX交换机组件个数");
    ...
    private void jRadioButton1ActionPerformed(ActionEvent evt) {
        ...
        nowModel.setNumOfSW(1);
        jTextField1.setText("1");
    }

    private void jRadioButton2ActionPerformed(ActionEvent evt) {
        // TODO add your handling code here:
        nowModel.setNumOfSW(2);
        jTextField1.setText("2");
    }

    private void jRadioButton3ActionPerformed(ActionEvent evt) {
        // TODO add your handling code here:
        nowModel.setNumOfSW(3);
    ...
    private void jButton2ActionPerformed(ActionEvent evt) {
        ...
        if(!num.equals(""))
        {
            Pattern pattern = Pattern.compile("[1|2|3|][0-6]*");
...
//    	ModelGuideDialog3 guiDialog =  ModelGuideDialog3Factory.getDialog(CreateGui.getApp(), true, nowVo);
            ModelGuideDialog444 guiDialog =  new ModelGuideDialog444(ApplicationSettings.getApplicationView(), true, nowModel,count,arr,null);
            guiDialog.pack();
