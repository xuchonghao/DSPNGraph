...
public class ModelGuideDialog2 extends JDialog {
    ...
    private void initComponents() {
        ...
        jLabel2.setText("  请选择SPM发送端系统组件的个数");
       ...
       // jLabel5.setText("其他");
        ...
        jLabel4.setText("根据系统情况，选择发送端系统组件个数");
...
//    	ModelGuideDialog3 guiDialog =  ModelGuideDialog3Factory.getDialog(CreateGui.getApp(), true, nowVo);
        ModelGuideDialog21 guiDialog =  new ModelGuideDialog21(ApplicationSettings.getApplicationView(), true, nowModel);
        guiDialog.pack();
    ...
    private void jButton4ActionPerformed(java.awt.event.ActionEvent evt) {
        // TODO add your handling code here:   上一步
           ...
           nowModel.setNumOfSPM(1);//设置终端数默认为1
