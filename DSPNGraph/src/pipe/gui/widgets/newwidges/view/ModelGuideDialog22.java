...
public class ModelGuideDialog22 extends JDialog {
    ...
    private void initComponents() {
        ...
        jLabel2.setText("  请选择接收端系统(RES)组件的个数");
       ...
       // jLabel5.setText("其他");
        ...
        jLabel4.setText("根据系统情况，选择接收端系统组件个数");
...
//    	ModelGuideDialog3 guiDialog =  ModelGuideDialog3Factory.getDialog(CreateGui.getApp(), true, nowVo);
        ModelGuideDialog23 guiDialog =  new ModelGuideDialog23(ApplicationSettings.getApplicationView(), true, nowModel);
        guiDialog.pack();
    ...
    private void jButton4ActionPerformed(ActionEvent evt) {
        ...
        nowModel.setNumOfDU(1);//将接收端设置为默认值
