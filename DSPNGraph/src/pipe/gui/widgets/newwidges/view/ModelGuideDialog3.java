    ...
    private void initComponents() {
        ...
        for(int i=0;i<spmNum;i++){
            ...
            for(int j=0;j<parNum;j++){
                jLabelArray1[count] = new javax.swing.JLabel();
      ...
      /*  int num = nowModel.getNumOfSPM();
        ...
        jLabel2.setText("<html>请设置每个发送端系统SPM分区中的虚链路的数量(0表示该分区不存在)<html>");
...
//            jPanel1Layout.setAutoCreateContainerGaps(true);
        ...
        for(int i=0;i<spmNum;i++){
            ...
            for(int j=0;j<parNum;j++){//每个分区中VL的数量及传输周期
                ...
                jTextFieldArray2[count].setText(spmId+"_Par"+ (j+1));
...
//            gp4.addComponent(jTextField4_3,javax.swing.GroupLayout.PREFERRED_SIZE, 86, javax.swing.GroupLayout.PREFERRED_SIZE);
       ...
       /* GroupLayout.ParallelGroup gp5 = jPanel2Layout.createParallelGroup(GroupLayout.Alignment.LEADING);
        ...
        jPanel2Layout.setHorizontalGroup(jPanel2Layout.createSequentialGroup()
                .addGroup(gp1).addGap(30).addGroup(gp2).addGap(30).addGroup(gp3).addGap(30).addGroup(gp55));//.addGroup(gp4).addGap(30).addGroup(gp5).addGap(30).addGroup(gp55));
    ...
    private void jButtonPrevStepActionPerformed(java.awt.event.ActionEvent evt) {
        ...
        for(int i=0;i<spmNum;i++){
            ...
            spm.setParList(parList);//上一步把分区列表初始化
            spmList.add(spm);
        }

        this.nowModel.setSpmList(spmList);
        doClose(RET_CANCEL);
        ModelGuideDialog21 guiDialog1 =  new ModelGuideDialog21(ApplicationSettings.getApplicationView(), true, this.nowModel);
        guiDialog1.pack();
    ...
    private void jButtonNextStepActionPerformed(java.awt.event.ActionEvent evt) {
        ...
        doClose(RET_OK);
    	ModelGuideDialog22 guiDialog =  new ModelGuideDialog22(ApplicationSettings.getApplicationView(), true, this.nowModel);
        guiDialog.pack();
