...
public class ModuleManager{
    ...
    private DefaultMutableTreeNode samodule;//,steadymodule;
    ...
    File getModuleDir(){
        ...
        System.out.println("modLocation:" + modLocation.getName() + "," + modLocation.getAbsolutePath());
        return modLocation;
    }
    /**这里是新加的*/
    File getModuleDirtest(){
        File modLocation = new File(ExtFileManager.getClassRoot(this.getClass()),
                                    System.getProperty("file.separator") + "pipe" +
                                            System.getProperty("file.separator") + "hla" +
                                            System.getProperty("file.separator") + "SimDSPNModule"+
                System.getProperty("file.separator") + "ordinarysimulation");
        ...
        System.out.println("modLocation2:" + modLocation.getName() + "," + modLocation.getAbsolutePath());
        return modLocation;
    }
    /**这里是新加的*/
    File getModuleDirtest2(){
        File modLocation = new File(ExtFileManager.getClassRoot(this.getClass()),
                System.getProperty("file.separator") + "pipe" +
                        System.getProperty("file.separator") + "hla" +
                        System.getProperty("file.separator") + "SimDSPNModule"+
                        System.getProperty("file.separator") + "hlasimulation");
    ...
    /**这里是新加的
    File getModuleSteady()
    {
        File modLocation = new File(ExtFileManager.getClassRoot(this.getClass()),
                                    System.getProperty("file.separator") + "pipe" +
                                            System.getProperty("file.separator") + "steadymodules");
        ...
        System.out.println("modLocation3:" + modLocation.getName() + "," + modLocation.getAbsolutePath());
        return modLocation;
    }*/
    /**
    ...
    /**这里是新加的*/
    private void addClassToTreetest(Class moduleClass)
    {
        DefaultMutableTreeNode modNode;
        if(installedModules.add(moduleClass))
        {
            ...
            if(modNode.getChildCount() == 1)
            {
                Object m = ((DefaultMutableTreeNode) modNode.getFirstChild()).
                        getUserObject();
                samodule.add(new DefaultMutableTreeNode(m));
            }
            else samodule.add(modNode);
        }
    }
    ...
    public JTree getModuleTree()
    {
        ...
        /**这里是新加的*/
        Vector namestest = new Vector();

        Vector classestest = new Vector();
        Vector namessteady = new Vector();
        Vector classessteady= new Vector();
        ...
        else
        {
            ...
            /**这里是新加的*/
            File testdir = getModuleDirtest();
            File testdir2 = getModuleDirtest2();
            //File steadydir = getModuleSteady();
            // get the names of all the classes that are confirmed to be modules
            ...
            /**这里是新加的*/
            namestest = getModuleClasses(testdir);
            classestest.addAll(namestest);
            namestest = getModuleClasses(testdir2);
            classestest.addAll(namestest);
            
            //namessteady = getModuleClasses(steadydir);
            classessteady.addAll(namessteady);
        }
        ...
        /**这里是新加的*/
        samodule = new DefaultMutableTreeNode("SimDSPN Modules");
        ...
        /**这里是新加的*/
        Iterator iteratorsa = classestest.iterator();
        while(iteratorsa.hasNext())
        {
            try
            {
                // create each ModuleClass node using an instantiation of the
                // ModuleClass
                addClassToTreetest((Class) iteratorsa.next());
            }
            catch(Throwable e)
            {
                System.out.println("Error in creating class node");
        ...
        /**这里是新加的*/
        Iterator iterator1 = classessteady.iterator();
        while(iterator1.hasNext())
        {
            try
            {
                // create each ModuleClass node using an instantiation of the
                // ModuleClass
                addClassToTreetest((Class) iterator1.next());
            }
            catch(Throwable e)
            {
                System.out.println("Error in creating class node");
