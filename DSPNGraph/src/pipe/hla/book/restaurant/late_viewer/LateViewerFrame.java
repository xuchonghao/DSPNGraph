...
//Title:        LateViewer Federate for Book: user interface
//Version:      
//Copyright:    Copyright (c) 1998
//Author:       Frederick Kuhl
//Company:      The MITRE corporation
//Description:  Viewer modified to join federation "late"
...
public class LateViewerFrame extends JFrame {
  int _federateHandle;
	String _fedexName;
	LateViewer _impl;
  ...
  void resignButton_actionPerformed(ActionEvent e) {
    String string1 = "Resign";
    String string2 = "Cancel";
    Object[] options = {string1, string2};
    Object[] message = {
      "This will resign the federate.    ",
      "Continue?"};
  ...
  private void jbInit() throws Exception {
    ...
    resignButton.addActionListener(new ActionListener() {
      public void actionPerformed(ActionEvent e) {
        resignButton_actionPerformed(e);
      }
    });
    this.getContentPane().add(northPanel, BorderLayout.NORTH);
    northPanel.add(clearLog, BorderLayout.EAST);
    northPanel.add(resignButton, BorderLayout.WEST);
