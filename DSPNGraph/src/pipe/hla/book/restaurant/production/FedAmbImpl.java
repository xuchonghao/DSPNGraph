...
public final class FedAmbImpl implements FederateAmbassador {
    ...
    ProductionFrame ui)
  {
	...
	throws
		...
		FederateInternalError
	{
		_fed.queueAttributeOwnershipDivestitureNotification(theObject, releasedAttributes);
	}
	// 7.9
	...
	throws		InteractionClassNotKnown,		InteractionParameterNotKnown,		InvalidFederationTime,		FederateInternalError	{
  		...
  		_fed.queueReceiveInteractionEvent(interactionClass,theInteraction,theTime);
	}
	// 6.7
	...
	// 8.3
	public void timeRegulationEnabled (		LogicalTime theFederateTime)	throws
		InvalidFederationTime,		EnableTimeRegulationWasNotPending,		FederateInternalError
	{
