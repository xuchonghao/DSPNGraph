...
public final class FedAmbImpl implements FederateAmbassador {
    ...
    ConsumptionFrame ui)
  {
	...
	throws
		...
		FederateInternalError
	{
		_fed.queueAttributeOwnershipAcquisitionUnavailableCallback(theObject, theAttributes);
	}
	// 6.13
	...
	throws
		...
		FederateInternalError
	{
		_fed.queueDiscoverObjectInstanceCallback(theObject, theObjectClass, objectName);
	}
	// 4.21
	...
	throws
		...
		FederateInternalError
	{
    //this federate will get this callback each time the Transport federate declares
    //it wishes to give away a position attribute, but the federate does nothing
    //with it
	}
	// 7.10
