...
public final class TestFederate
{
   ...
   public ParameterHandleValueMapFactory _suppliedParametersFactory;
   public AttributeHandleValueMapFactory _suppliedAttributesFactory;
   ...
   public TestFederate(Properties props)
   {
      ...
      if (lrcPort != null) System.out.println("LRC port: " + lrcPort);
...
//
//
//   void attributeOwnershipReleaseResponse(
//           String objectString,
//           AttributeHandleSet ahset)
//   {
//      int objectHandle;
...
//   }
   ...
   void createFederationExecution(String[] stuff) {
      try {
         ...
         else fddFileLocation = stuff[1];
         fddFile = new File(fddFileLocation);
         _userInterface.post("4.2 Starting to create federation execution with FED "
                 + fddFileLocation + "...");
         _rti.createFederationExecution(stuff[0], fddFile.toURL());
...
//    */
//   public String
//           getParameterName(String pHandleString, String classString)
//   {
//      String name = null;
//      int classHandle;
//      int pHandle;
...
//   }
   ...
   public void federateRestoreComplete() {
      try {
         ...
         _userInterface.post("4.22 federate restore complete.");
      }
      catch (Exception e) {
         _userInterface.post("EX 4.22 federateRestoreComplete " + e);
      }
   }

   public void federateRestoreNotCompleteMenuItem() {
      try {
         _rti.federateRestoreNotComplete();
         _userInterface.post("4.22 federate restore not complete.");
      }
      catch (Exception e) {
         _userInterface.post("EX 4.22 federateRestoreNotCompleteMenuItem " + e);
      }
   }
   ...
   public void queryFederationSaveStatus() {
      try {
         _rti.queryFederationSaveStatus();
         _userInterface.post("4.16 query federation save status");
      } catch (Exception e) {
         _userInterface.post("EX 4.16 queryFederationSaveStatus " + e);
      }
   }

   public void queryFederationRestoreStatus() {
      try {
         _rti.queryFederationRestoreStatus();
         _userInterface.post("4.24 query federation restore status");
      } catch (Exception e) {
         _userInterface.post("EX 4.24 queryFederationRestoreStatus " + e);
      }
   }
...
//   }
   ...
   void joinFederationExecution(String[] args) {
      ...
      try {
         ...
         try {
            _suppliedParametersFactory = _rti.getParameterHandleValueMapFactory();

            _suppliedAttributesFactory = _rti.getAttributeHandleValueMapFactory();
...
//   }
   ...
   public void requestFederationRestore(String[] stuff) {
      try {
         ...
         _userInterface.post("4.18 request federation restore.");
      }
      catch (Exception e) {
         _userInterface.post("EX 4.18 requestFederationRestore " + e);
      }
   }
   ...
   void resignFederationExecution(String resignActionDescription, ResignAction resignAction) {
      try {
         ...
         _userInterface.post("4.5 Resigned with action " + resignActionDescription);
      }
      catch (Exception e) {
...
//         }
//         ParameterHandleValueMap sp = _suppliedParametersFactory.create(3);
//         if (!stuff[1].equals("")) {
//            try {
...
//         AttributeHandleValueMap sa = _suppliedAttributesFactory.create(3);
//         if (!stuff[1].equals("")) {
//            try {
//               h1 = Integer.parseInt(stuff[1]);
//            }
