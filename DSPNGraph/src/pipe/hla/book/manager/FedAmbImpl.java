...
public final class FedAmbImpl implements FederateAmbassador {
  ...
  public FedAmbImpl(    Manager fed,    ManagerFrame ui)
  {
	_fed = fed;
	_userInterface = ui;
  }          
	...
	throws
		...
		FederateInternalError
	{
    _fed.queueReflectAttributeValuesCallback(
      theObject,
      theAttributes,
      userSuppliedTag);
	}
