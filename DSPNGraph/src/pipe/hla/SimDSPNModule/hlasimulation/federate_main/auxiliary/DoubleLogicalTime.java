...
public class DoubleLogicalTime extends se.pitch.prti1516.LogicalTimeDouble implements LogicalTime{

    double value;
    public DoubleLogicalTime(double v) {
        super(v);
        value = v;
    }
    ...
    @Override
    public DoubleLogicalTime add(LogicalTimeInterval logicalTimeInterval) throws IllegalTimeArithmetic {
        return new DoubleLogicalTime(value +((LogicalTimeIntervalDouble)logicalTimeInterval).getValue());
    }
